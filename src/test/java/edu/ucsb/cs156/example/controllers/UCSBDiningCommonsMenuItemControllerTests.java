...
public class UCSBDiningCommonsMenuItemControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_ucsbdiningcommonsmenuitem() throws Exception {
                ...
                UCSBDiningCommonsMenuItem iceCream = UCSBDiningCommonsMenuItem.builder()
                                .diningCommonsCode("ortega")
                                .name("ice-cream")
                                .station("dessert")
                                .build();

                UCSBDiningCommonsMenuItem caesarSalad = UCSBDiningCommonsMenuItem.builder()
                ...
                expectedItem.addAll(Arrays.asList(iceCream, caesarSalad));
        ...
        public void an_admin_user_can_post_a_new_item() throws Exception {
                ...
                when(ucsbDiningCommonsMenuItemRepository.save(eq(caesarSalad))).thenReturn(caesarSalad);

                // act
                MvcResult response = mockMvc.perform(
                                post("/api/ucsbdiningcommonsmenuitem/post?diningCommonsCode=dlg&name=caesar-salad&station=entrees")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();

                // assert
                verify(ucsbDiningCommonsMenuItemRepository, times(1)).save(caesarSalad);
                String expectedJson = mapper.writeValueAsString(caesarSalad);
                String responseString = response.getResponse().getContentAsString();
                assertEquals(expectedJson, responseString);
        }
        ...
        public void admin_can_delete_an_item() throws Exception {
                ...
                UCSBDiningCommonsMenuItem sushi = UCSBDiningCommonsMenuItem.builder()
                                .diningCommonsCode("portola")
                                .name("sushi")
                                .station("entrees")
                                .build();

                when(ucsbDiningCommonsMenuItemRepository.findById(eq(15L))).thenReturn(Optional.of(sushi));
